...
/**
 * SecurityManager 是一个允许应用程序实现安全策略的类。
 * 它允许应用程序在执行一个可能不安全或敏感的操作之前，决定是否在安全上下文中进行尝试，是否允许执行操作。
 * 应用程序可以继续或取消操作
 * <p>
 ...
 * <code>checkPermission</code> returns quietly. If denied拒绝, a
...
public class SecurityManager {
     ...
     *  建议 <code>checkPermission</code>
     */
    @Deprecated
    protected boolean inCheck;

    /*
     * Have we been initialized. 有效对抗终结攻击
     */
